...
"void extract_yuv(in int format, in int flip, in sampler2D texture0, in sampler2D texture1, in sampler2D texture2, out float y, out float u, out float v)\n"
"{\n"
"    y = 0.0; u = 0.0; v = 0.0;\n"
...
"	 }\n"	
"    if (format == 1) {\n"
"        y = texture2D(texture0, pos).r;\n"
"        y = 1.1643 * (y - 0.0625);\n"
"        u = texture2D(texture1, pos).r - 0.5;\n"
"        v = texture2D(texture2, pos).r - 0.5;\n"
"    } else if (format == 2) {\n"
"        y = texture2D(texture0, pos).r;\n"
"        y = 1.1643*(y-0.0625);\n"
"        u = texture2D(texture1, pos).g-0.5;\n"
"        v = texture2D(texture1, pos).a-0.5;\n"
"    } else if (format == 3) {\n"
"        y = texture2D(texture0, pos).g;\n"
"        y = 1.1643*(y-0.0625);\n"
"        u = texture2D(texture1, pos).r-0.5;\n"
"        v = texture2D(texture1, pos).b-0.5;\n"
"    }\n"
"}\n"
...
"    extract_yuv(format_1, flip_1, texture_0, texture_1, texture_2, y1, u1, v1);\n"
...
"        extract_yuv(format_2, flip_2, texture_3, texture_4, texture_5, y2, u2, v2);\n"
